...
/**
* \addtogroup ECAT_FOE ECAT_FOE
* @{
*/

/**
\file ECAT_FOEObjects
\author ET9300Utilities.ApplicationHandler (Version 1.6.4.0) | EthercatSSC@beckhoff.com

\brief ECAT_FOE specific objects<br>
\brief NOTE : This file will be overwritten if a new object dictionary is generated!<br>
*/

#if defined(_ECAT__FOE_) && (_ECAT__FOE_ == 1)
#define PROTO
#else
#define PROTO extern
#endif
...
TOBJF000;
#endif //#ifndef _ECAT__FOE_OBJECTS_H_
