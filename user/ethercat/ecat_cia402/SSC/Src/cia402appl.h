 ...
 * csp     mode RxPDO mapping : 0x1600<br>
 * csp     mode TxPDO mapping : 0x1A00<br>
 * @{
 */
...
/** \brief 0x1A00 (csp TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[8]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
typedef struct OBJ_STRUCT_PACKED_START
{
    TOBJ1600 sRxPDOMap0; /**< \brief csp RxPDO (0x1600)*/
    TOBJ1A00 sTxPDOMap0; /**< \brief csp TxPDO (0x1A00)*/
    ...
    UINT32 objMaxMotorSpeedValue;/**< \brief Max motor speed (0x6080)*/
    ...
    UINT32 objPDOInputs;//60B9
    UINT32 objPDOOutputs;//60B8
}OBJ_STRUCT_PACKED_END
CiA402Objects;
...
/**
 * \brief Object 0x1600 (csp RxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1600 (csp RxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */   
OBJCONST UCHAR OBJMEM aName0x1600[] = "csp RxPDO\000\377";
...
/**
 * \brief Object 0x1A00 (csp RxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A00 (csp TxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST UCHAR OBJMEM aName0x1A00[] = "csp TxPDO\000\377";
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6080 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING)};
...
/** \brief Object 0x60B9 PDO Input entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x60B9 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READ | OBJACCESS_TXPDOMAPPING)};

/** \brief Object 0x60B9 PDO Input object name*/
OBJCONST UCHAR OBJMEM aName0x60B9[] = "PDO Input";

/** \brief Object 0x60B8 PDO Output entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x60B8 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING)};

/** \brief Object 0x60B8 PDO Output object name*/
OBJCONST UCHAR OBJMEM aName0x60B8[] = "PDO Output";
...
#ifdef _CiA402_
= {
{8, {0x60400010,0x607A0020,0x60600008,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000}}, /*TOBJ1600*/
{8, {0x60410010,0x60640020,0x60610008,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000}}, /*TOBJ1A00*/
...
0x0,/*(UINT32) Max profile velocity 0x607F*/
0x0,/*(UINT32) Max motor speed 0x6080*/
...
= {
   /* Object 0x1600 */
   {NULL,NULL, 0x1600, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1600, aName0x1600, NULL, NULL, NULL, 0x0000 },
   /* Object 0x1A00 */
   {NULL,NULL, 0x1A00, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1A00, aName0x1A00, NULL, NULL, NULL, 0x0000 },
   /* Object 0x603F */
   ...
   /* Object 0x607F */
   {NULL,NULL, 0x607F, {DEFTYPE_UNSIGNED32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x607F, aName0x607F, NULL, NULL, NULL, 0x0000 },
   /* Object 0x6080 */
   {NULL,NULL, 0x6080, {DEFTYPE_UNSIGNED32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6080, aName0x6080, NULL, NULL, NULL, 0x0000 },
   /* Object 0x6085 */
   ...
   /* Object 0x60B9 */
   {NULL,NULL, 0x60B9, {DEFTYPE_UNSIGNED32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x60B9, aName0x60B9, NULL, NULL, NULL, 0x0000 },
   /* Object 0x60B8 */
   {NULL,NULL, 0x60B8, {DEFTYPE_UNSIGNED32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x60B8, aName0x60B8, NULL, NULL, NULL, 0x0000 },
   {NULL,NULL, 0xFFFF, {0, 0}, NULL, NULL, NULL, NULL, NULL, 0x000}}
#endif
;
