...
#ifndef ALLOCMEM
#define ALLOCMEM(size)                            aic_tlsf_malloc(0,size)
#endif

/** 
FREEMEM(pointer): Should be defined to the free function to put back dynamic memory */
#ifndef FREEMEM
#define FREEMEM(pointer)                          aic_tlsf_free(0,pointer)
#endif
...
#define APPL_AllocMailboxBuffer(size)             aic_tlsf_malloc(0,size)
#endif
...
#define APPL_FreeMailboxBuffer(pointer)           aic_tlsf_free(0,pointer)
#endif
...
#define STRUCT_PACKED_START                       PACKED_ATTR
#endif
...
#define MBX_STRUCT_PACKED_START                   PACKED_ATTR
#endif
...
#define OBJ_STRUCT_PACKED_START                   PACKED_ATTR
#endif
...
#define MAX_PD_INPUT_SIZE                         0x0000 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x0000 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
