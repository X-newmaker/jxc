...
\brief ECAT_IO specific objects<br>
\brief NOTE : This file will be overwritten if a new object dictionary is generated!<br>
*/

#if defined(_ECAT__IO_) && (_ECAT__IO_ == 1)
#define PROTO
#else
#define PROTO extern
#endif
...
TOBJ1600;
#endif //#ifndef _ECAT__IO_OBJECTS_H_
...
* <br>
* SubIndex 0<br>
* SubIndex 1 - Results1<br>
* SubIndex 2 - Results2<br>
* SubIndex 3 - Toggle<br>
* SubIndex 4<br>
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6000[] = {
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex1 - Results1 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex2 - Results2 */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
UINT16 Results1; /* Subindex1 - Results1 */
UINT16 Results2; /* Subindex2 - Results2 */
...
* SubIndex 2 - Value 2<br>
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7000[] = {
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex1 - Value 1 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }}; /* Subindex2 - Value 2 */
...
UINT16 Value2; /* Subindex2 - Value 2 */
} OBJ_STRUCT_PACKED_END
TOBJ7000;
#endif //#ifndef _ECAT__IO_OBJECTS_H_
...
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE }}; /* Subindex1 - Inc 1 */
