...
#else
#define AHBBASIC_NOTI_ALL_DMA_WRIT      (1 << 31)
#define AHBBASIC_REM_MEM_SUPP           (1 << 30)
#define AHBBASIC_INV_DESC_ENDIANNESS    (1 << 29)
#define AHBBASIC_AHB_SINGLE             (1 << 28)
#define AHBBASIC_TXENDDELAY             (1 << 27)
#define AHBBASIC_AHBIDLE                (1 << 26)
#define AHBBASIC_DMAREQ                 (1 << 25)
#endif
...
/* fifo size configure */
#ifdef AIC_M7000T_CONFIG
#define EPS_NUM                         3
#define PERIOD_IN_EP_NUM                2
#define TOTAL_FIFO_SIZE                 0x1FB
#define AIC_RX_FIFO_SIZE                0x80
#define AIC_NP_TX_FIFO_SIZE             0x80
#define AIC_PERIOD_TX_FIFO1_SIZE        0x80
#else
#define EPS_NUM                         5
#define PERIOD_IN_EP_NUM                2
