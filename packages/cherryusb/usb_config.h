...
/* ================ USB Driver version Configuration ================*/
#define AIC_M7000T_CONFIG
#ifdef AIC_M7000T_CONFIG
#define LPKG_CHERRYUSB_DEVICE_AIC_CPU
#define UDC_TXFIFO_NUM			1U
#define USB_EP_NUM				3U
#endif

/* ================ USB Device Port Configuration ================*/
#define AIC_USING_USB0_DEVICE
...
#define CONFIG_USB_AIC_DC_MOD       (CMU_MOD_USB_FS_DR)
#define CONFIG_USB_AIC_DC_PHY_MOD   (CMU_MOD_USB_FS_DR_PHY)
#define CONFIG_USB_AIC_DC_IRQ_NUM   (USB_DEV_IRQn)
#define USB_NUM_BIDIR_ENDPOINTS     (USB_EP_NUM)
#ifndef LPKG_CHERRYUSB_DEVICE_AIC_CPU
#define CONFIG_USB_AIC_DMA_ENABLE
#endif

#define CACHEABLE_USB
#ifndef CACHEABLE_USB
#define USB_NOCACHE_RAM_SECTION __attribute__((section(".ucm_data")))
#else
#define USB_NOCACHE_RAM_SECTION
#endif
