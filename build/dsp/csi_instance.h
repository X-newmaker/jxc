...
#define __STATIC_FORCEINLINE  __attribute__((unused)) static inline
#define CSI_NEWTON_SQRTF
#ifdef __CK860__
#define __STATIC_INLINE  __attribute__((unused)) static inline
 ...
 */
__STATIC_FORCEINLINE int8_t __QADD(
    int32_t x,
    int32_t y)
{
...
{
    __ASM volatile("mula.int32_t.rhs %0, %1, %2\n\t"
...
{
    __ASM volatile("muls.int32_t.rhs %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    int32_t a;
    __ASM volatile("mul.int32_t.rh %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "1" (x), "2" (y));
    return a;
}
...
{
    __ASM volatile("mula.int32_t.hs %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    __ASM volatile("muls.int32_t.hs %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    int32_t a;
    __ASM volatile("mul.int32_t.h %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    __ASM volatile("mulall.int16_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    __ASM volatile("mulall.int16_t.e %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    int64_t a;
    __ASM volatile("mul.int32_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "1" (x), "2" (y));
    return a;
}
...
{
    __ASM volatile("mula.int32_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "0" (a), "1" (x), "2" (y));
    return a;
}
...
{
    int32_t a;
    __ASM volatile("mulll.int16_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "1" (x), "2" (y));
    return a;
}
...
{
    int32_t a;
    __ASM volatile("mulhl.int16_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "1" (x), "2" (y));
    return a;
}
...
{
    int32_t a;
    __ASM volatile("mulhh.int16_t %0, %1, %2\n\t"
                   :"=r" (a), "=r" (x), "=r" (y): "1" (x), "2" (y));
    return a;
}
